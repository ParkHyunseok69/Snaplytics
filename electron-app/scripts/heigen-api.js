...
const MOCK_CUSTOMERS = [
    { id: 1, name: 'Maria Santos', email: 'maria@email.com', contact: '0917-123-4567', consent: true, bookings: 3 },
    { id: 2, name: 'Juan Dela Cruz', email: 'juan@email.com', contact: '0918-234-5678', consent: false, bookings: 1 },
    { id: 3, name: 'Ana Rodriguez', email: 'ana@email.com', contact: '0919-345-6789', consent: true, bookings: 5 },
    { id: 4, name: 'Pedro Martinez', email: 'pedro@email.com', contact: '0920-456-7890', consent: true, bookings: 2 },
    { id: 5, name: 'Lisa Garcia', email: 'lisa@email.com', contact: '0921-567-8901', consent: false, bookings: 0 },
    { id: 6, name: 'Carlos Reyes', email: 'carlos@email.com', contact: '0922-678-9012', consent: true, bookings: 4 },
    { id: 7, name: 'Sofia Cruz', email: 'sofia@email.com', contact: '0923-789-0123', consent: true, bookings: 6 },
...
const MOCK_PACKAGES = [
    ...
    { 
        ...
        category: 'standard',
        inclusions: ['4 hours coverage', '100 edited photos', '1 photographer', 'Online gallery']
    },
    { 
        id: 3, 
        ...
        category: 'premium',
        inclusions: ['6 hours coverage', '200 edited photos', '2 photographers', 'Online gallery', 'USB drive']
    },
    { 
        id: 4, 
        name: 'DELUXE PACKAGE', 
        ...
        category: 'deluxe',
        inclusions: ['8 hours coverage', '300 edited photos', '2 photographers', 'Videographer', 'Online gallery', 'Premium USB', 'Photo book']
    },
    { 
        id: 5, 
        name: 'WEDDING BASIC', 
        ...
        category: 'wedding',
        inclusions: ['Full day coverage', '250 edited photos', '2 photographers', 'Engagement shoot']
    },
    { 
        id: 6, 
        ...
        category: 'wedding',
        inclusions: ['Full day coverage', '500 edited photos', '3 photographers', '2 videographers', 'Engagement shoot', 'Same day edit', 'Wedding album']
    }
];

const MOCK_ADDONS = [
    { id: 1, name: 'EXTRA HOUR', description: 'Additional shooting time', price: 2000, category: 'time' },
    { id: 2, name: 'PHOTO ALBUM', description: 'Premium 12x12 photo album', price: 3500, category: 'product' },
    { id: 3, name: 'VIDEO PACKAGE', description: 'Professional video editing with highlights', price: 8000, category: 'video' },
    { id: 4, name: 'DRONE SHOTS', description: 'Aerial photography and videography', price: 5000, category: 'special' },
    { id: 5, name: 'PHOTO BOOTH', description: '3 hours unlimited prints', price: 6000, category: 'entertainment' },
    { id: 6, name: 'SAME DAY EDIT', description: 'Video highlights on event day', price: 10000, category: 'video' },
    { id: 7, name: 'EXTRA PHOTOGRAPHER', description: 'Additional photographer for 4 hours', price: 4000, category: 'staff' },
    { id: 8, name: 'RUSH EDITING', description: 'Get photos within 1 week', price: 3000, category: 'service' },
    { id: 9, name: 'CANVAS PRINT', description: '24x36 canvas wall art', price: 2500, category: 'product' }
];
...
const api = {
    ...
    /**
     * Password Reset
     * TODO: API CALL - Password Reset
     * Expected request: { email: string, new_password: string }
     * Expected response: { success: boolean, message: string }
     */
    ...
    async getCustomers(search = '', page = 1) {
        ...
        try {
            const token = sessionStorage.getItem('authToken');
            const response = await fetch(`${API_URL}/customers/?search=${search}&page=${page}`, {
                headers: { 
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
        ...
        if (MOCK_MODE) {
            ...
            if (customer) {
                return {
                    ...
                    history: [
                        { date: '2024-10-15', package: 'Premium Package', amount: 15000 },
                        { date: '2024-08-20', package: 'Standard Package', amount: 10000 }
                    ]
                };
            }
    ...
    async getPackages(search = '', category = '') {
        ...
        try {
            const token = sessionStorage.getItem('authToken');
            const response = await fetch(`${API_URL}/packages/?search=${search}&category=${category}`, {
                headers: { 
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
    ...
    async getAddons(search = '') {
        ...
        try {
            const token = sessionStorage.getItem('authToken');
            const response = await fetch(`${API_URL}/addons/?search=${search}`, {
                headers: { 
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
    ...
    async getDashboardStats() {
        ...
        try {
            ...
            return { total_customers: 0, total_bookings: 0, revenue: 0, popular_packages: [] };
        }
    },
